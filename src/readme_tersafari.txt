...
reference. Both are essentially the ZLIB license, but the Tersafari license 
may include differing copyright owners and usage clarifications.

Tersafari source code license, usage, and documentation.

You may use the Tersafari source code if you abide by the ZLIB license
...
ENet network library which Tersafari uses is covered by an MIT-style 
...
Robert "useoftoaster" Peele
http://airstrafe.com

For additional authors/contributors, see the distribution readme.
